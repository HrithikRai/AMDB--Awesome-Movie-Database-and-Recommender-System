def app():
    ...
    genre_cluster_data = pd.DataFrame(pickle.load(open("pickle_files/fav_genre_usergrps.pkl", 'rb')))
    user_data = pd.DataFrame(pickle.load(open("pickle_files/users.pkl", 'rb')))
    movies_data = pd.DataFrame(pickle.load(open("pickle_files/movies_data.pkl", 'rb')))
    ratings_data = pd.DataFrame(pickle.load(open("pickle_files/ratings.pkl", 'rb')))
